...
class TrainingData:
    def __init__(self, sentiments, vocabulary, vocabulary_header, vocabulary_body) -> None:
        self.sentiments: List[SentimentClass] = sentiments
...
def naive_bayes(train_path: str, val_path: str, pickle_path: str):
    ...
    actual_values = [comment.sentiment for comment in val_comments]
    calculated_values = [
        comment.calculated_sentiment for comment in val_comments]

    print("Naive Bayes")
    get_metrics(actual_values, calculated_values)
